...
public class HotelsController : ControllerBase
{
    ...
    {
        var filtered = hotels.Where(x => x.Address.Contains(findHotelDto.SearchTerm)
        || x.Name.Contains(findHotelDto.SearchTerm) || x.City.Name.Contains(findHotelDto.SearchTerm));
